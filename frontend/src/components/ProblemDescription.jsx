    ...
    <div className="h-full overflow-y-auto bg-base-200">
      ...
      <div className="p-6 bg-base-100 border-b border-base-300">
        <div className="flex items-start justify-between mb-3">
          ...
          <span className={`badge bg-yellow-400 border-none ${getDifficultyBadgeClass(problem.difficulty)}`}>
            {problem.difficulty}
          </span>
        </div>
              ...
              <div key={idx}>
                ...
                <div className="bg-base-200 rounded-lg p-4 font-mono text-sm space-y-1.5">
                  <div className="flex gap-2">
                    <span className="text-yellow-400/90 font-bold min-w-[70px]">Input:</span>
                    <span>{example.input}</span>
                  </div>
                  <div className="flex gap-2">
                    <span className="text-yellow-400/90 font-bold min-w-[70px]">Output:</span>
